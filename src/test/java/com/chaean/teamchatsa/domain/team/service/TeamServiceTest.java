...
class TeamServiceTest {
	...
	class RegisterTeam {
		...
		void success() {
			// given
			Long userId = 1L;
			TeamCreateRequest req = new TeamCreateRequest("teamName", "area", "description", ContactType.KAKAO, "contact", "imgUrl", "하하");
		...
		void fail_already_joined() {
			// given
			Long userId = 1L;
			TeamCreateRequest req = new TeamCreateRequest("teamName", "area", "description", ContactType.KAKAO, "contact", "imgUrl", "중하");
		...
		void fail_duplicate_team_name() {
			// given
			Long userId = 1L;
			TeamCreateRequest req = new TeamCreateRequest("teamName", "area", "description", ContactType.KAKAO, "contact", "imgUrl", "중상");
			given(teamMemberRepo.existsByUserId(userId)).willReturn(false);
	...
	class FindTeamDetail {
		...
		void success_as_member() {
			...
			// when
			TeamDetailResponse result = teamService.findTeamDetail(teamId, userId);
	...
	class ApplyToTeam {
		...
		void success() {
			...
			Long teamId = 1L;
			Long userId = 1L;
			TeamJoinRequest req = new TeamJoinRequest("message");
