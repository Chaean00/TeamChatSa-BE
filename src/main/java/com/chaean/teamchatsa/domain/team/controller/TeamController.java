...
public class TeamController {
	...
	@PostMapping("")
	public ResponseEntity<ApiResponse<Void>> createTeam(@AuthenticationPrincipal Long userId,
	...
	@GetMapping("")
	public ResponseEntity<ApiResponse<SliceResponse<TeamListResponse>>> getTeamList(
	...
	public ResponseEntity<ApiResponse<List<TeamMemberResponse>>> getTeamMembers(@PathVariable Long teamId) {
		List<TeamMemberResponse> res = teamService.findTeamMembers(teamId);
	...
	/** 팀 정보 수정 - LEADER 또는 CO_LEADER만 가능
	 @PutMapping("/{teamId}")
	 @RequireTeamRole(TeamRole.LEADER) public ResponseEntity<ApiResponse<Void>> updateTeam(
	 @PathVariable Long teamId,
