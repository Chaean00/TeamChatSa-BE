...
public interface TeamJoinRequestRepositoryCustom {
	 ...
	 */
	List<TeamApplicationResponse> findApplicationsByTeamId(Long teamId);

	/**
	 * 특정 팀의 특정 상태 가입 신청 목록 조회
	 */
	List<TeamApplicationResponse> findApplicationsByTeamIdAndStatus(Long teamId, JoinStatus status);
