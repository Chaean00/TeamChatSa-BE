...
public class NotificationService {
	...
	public Notification createNotification(Long recipientId, NotificationType type,
		...
		Notification notification = Notification.create(recipientId, type, content, link);
	...
	@Transactional
	@Loggable
	public List<Notification> createNotifications(List<Long> recipientIds, NotificationType type,
			String content, String link
	) {
