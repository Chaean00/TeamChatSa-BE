...
public class GcpStorageService {
	...
	@Loggable
	public PresignUploadResponse presignUpload(PresignUploadRequest req, Long userId) {
		validate(req);
		...
		return new PresignUploadResponse(objectName, signedUrl.toString(), publicUrl, expireSeconds);
	}

	/** 요청 유효성 검증 */
	private void validate(PresignUploadRequest req) {
