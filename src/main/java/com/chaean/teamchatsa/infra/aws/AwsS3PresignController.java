...
@Tag(name = "AWS S3 API", description = "AWS S3 서명된 URL 관련 API")
@RestController
...
public class AwsS3PresignController {
	...
	@Operation(summary = "S3 업로드용 Presigned URL 발급 API", description = "AWS S3에 파일 업로드를 위한 Presigned URL을 발급합니다.")
