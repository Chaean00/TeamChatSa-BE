CREATE TABLE IF NOT EXISTS "user" (
    ...
    CONSTRAINT user_role_check CHECK (role IN ('ROLE_LEADER', 'ROLE_PLAYER')),
...
CREATE TABLE IF NOT EXISTS "team_join_request" (
    ...
    CONSTRAINT team_join_request_status_check CHECK (status IN ('PENDING','ACCEPTED','REJECTED','CANCELLED')),
    message VARCHAR(255) ,
    created_at        TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    updated_at        TIMESTAMP WITHOUT TIME ZONE NOT NULL,
